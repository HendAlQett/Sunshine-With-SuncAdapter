...
//                    .build();
            ...
            myLayout = inflater.inflate(R.layout.weather_watchface, null);
            ...
            mClockMin = (TextView) myLayout.findViewById(R.id.clockMin);
            mMaxView = (TextView) myLayout.findViewById(R.id.tvMax);
            mMinView = (TextView) myLayout.findViewById(R.id.tvMin);
...
//                    mTextPaint.setAntiAlias(!inAmbientMode);
        ...
        public void onDraw(Canvas canvas, Rect bounds) {
            ...
            if (isInAmbientMode()) {
                ...
                mMinView.setTextColor(Color.WHITE);
                mLine.setBackgroundColor(Color.WHITE);

            } else {
                canvas.drawRect(0, 0, bounds.width(), bounds.height(), mBackgroundPaint);
                canvas.drawColor(getResources().getColor(R.color.primary));
                mDate.setTextColor(getResources().getColor(R.color.primary_light));
                mMinView.setTextColor(getResources().getColor(R.color.primary_light));
                mLine.setBackgroundColor(getResources().getColor(R.color.primary_light));
            }
            ...
            mDate.setText(String.format("%ta, %tb %2d %tY",mTime.toMillis(false),mTime.toMillis(false),mTime.monthDay,mTime.toMillis(false)));
            // Apply it to the time fields
            mClockHour.setText(String.format("%02d", mTime.hour));
            mClockMin.setText(String.format(":%02d", mTime.minute));
